...
public class imagenes2 extends AppCompatActivity {
    private Button atras, mas1, elegir;
    private Rect rect;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        atras = findViewById(R.id.btn_Atras1);
        mas1 = findViewById(R.id.btn_MoreImgs3);
        ...
        iv1.setTag(R.drawable.iv2);
        iv2.setTag(R.drawable.iv13);
        iv3.setTag(R.drawable.iv10);
        iv4.setTag(R.drawable.iv11);
        iv5.setTag(R.drawable.iv12);
        iv6.setTag(R.drawable.iv14);
        iv7.setTag(R.drawable.iv15);
        iv8.setTag(R.drawable.iv24);
        iv9.setTag(R.drawable.iv20);
        iv10.setTag(R.drawable.iv9);
        iv11.setTag(R.drawable.iv5);
        iv12.setTag(R.drawable.iv34);

        elegir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(valorImagen == 1) {
                    Intent i = new Intent(imagenes2.this, IncluirRSS.class);
                    i.putExtra("imagen", R.drawable.iv2);
                    startActivity(i);
                } else if(valorImagen == 2) {
                    Intent i = new Intent(imagenes2.this, IncluirRSS.class);
                    i.putExtra("imagen", R.drawable.iv13);
                    startActivity(i);
                } else if(valorImagen == 3) {
                    Intent i = new Intent(imagenes2.this, IncluirRSS.class);
                    i.putExtra("imagen", R.drawable.iv10);
                    startActivity(i);
                } else if(valorImagen == 4) {
                    Intent i = new Intent(imagenes2.this, IncluirRSS.class);
                    i.putExtra("imagen", R.drawable.iv11);
                    startActivity(i);
                } else if(valorImagen == 5) {
                    Intent i = new Intent(imagenes2.this, IncluirRSS.class);
                    i.putExtra("imagen", R.drawable.iv12);
                    startActivity(i);
                } else if(valorImagen == 6) {
                    Intent i = new Intent(imagenes2.this, IncluirRSS.class);
                    i.putExtra("imagen", R.drawable.iv14);
                    startActivity(i);
                } else if(valorImagen == 7) {
                    Intent i = new Intent(imagenes2.this, IncluirRSS.class);
                    i.putExtra("imagen", R.drawable.iv15);
                    startActivity(i);
                    ...
                    Intent i = new Intent(imagenes2.this, IncluirRSS.class);
                    i.putExtra("imagen", R.drawable.iv20);
                    startActivity(i);
                } else if(valorImagen == 10) {
                    Intent i = new Intent(imagenes2.this, IncluirRSS.class);
                    i.putExtra("imagen", R.drawable.iv9);
                    startActivity(i);
                } else if(valorImagen == 11) {
                    Intent i = new Intent(imagenes2.this, IncluirRSS.class);
                    i.putExtra("imagen", R.drawable.iv5);
                    startActivity(i);
                } else if(valorImagen == 12) {
                    Intent i = new Intent(imagenes2.this, IncluirRSS.class);
                    i.putExtra("imagen", R.drawable.iv34);
                    startActivity(i);
                }
            }
        });
        atras.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), imagenes.class);
                startActivity(i);
            }
        });
        mas1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), imagenes3.class);
                startActivity(i);
            }
        });
